<?php
  ...
  if( ! class_exists( 'KP_WP_List_Table' ) ) {
    require_once( KP_DIR_PATH . 'includes/wp-classes/class-wp-list-table.php' );
  }

  if ( ! class_exists( 'KP_Korapay_Payment_List' ) ) {

    /**
     * Payment List Class to add list payments made
     * via the payment buttons
     */
    class KP_Korapay_Payment_List extends KP_WP_List_Table {
      ...
      public function __construct() {
        ...
        parent::__construct( array(
          'singular' => __( 'Payment List', 'korapay-pay' ),
          'plural'   => __( 'Payment Lists', 'korapay-pay' ),
          'ajax'     => false
        ) );
      ...
      public function no_items() {
        _e( 'No payments have been made yet.', 'korapay-pay' );
      }
      ...
      public function column_tx_ref( $item ) {
        ...
        $title = '<strong>' . get_post_meta( $item->ID, '_kp_korapay_payment_tx_ref', true ) . '</strong>';
      ...
      public function column_amount( $item ) {
        $amount = get_post_meta( $item->ID, '_kp_korapay_payment_amount', true );
      ...
      public function column_default( $item, $column_name ) {
        ...
        switch ( $column_name ) {
          ...
          case 'fullname':
          case 'status':
            return get_post_meta( $item->ID, '_kp_korapay_payment_' . $column_name, true );
          case 'date':
      ...
      function get_columns() {
        ...
        $columns = array(
          ...
          'tx_ref'  => __( 'Transaction Ref', 'korapay-pay' ),
          'customer' => __( 'Customer', 'korapay-pay' ),
          'fullname' => __('Customer Fullname', 'korapay-pay'),
          'amount'  => __( 'Amount (' . $admin_settings->get_option_value( 'currency' ) . ')', 'korapay-pay' ),
          'status'  => __( 'Status', 'korapay-pay' ),
          'date'    => __( 'Date', 'korapay-pay' ),
        );
      ...
      public function add_to_menu() {
        ...
        $hook = add_submenu_page(
          ...
          __( 'korapay Transaction List', 'korapay-pay' ),
          __( 'Transactions', 'korapay-pay' ),
          'manage_options',
          'kp_payment_list',
      ...
      public function payment_list_table() {
        ...
        require_once( KP_DIR_PATH . 'views/payment-list-table.php' );
      ...
      /**
       * Gets the total payments made through korapay
       *
      ...
      public function add_payment_list_post_type() {
        ...
        $args = array(
          'label'               => __( 'Payment Lists', 'korapay-pay' ),
          'description'         => __( 'korapay payment lists', 'korapay-pay' ),
